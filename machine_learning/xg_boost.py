...
class XGBoostModel:
    ...
    def train_disease(self, disease):
        ...
        lr = XGBClassifier(n_jobs = 4, scale_pos_weight = ratio_value)
        ...
        model.save_model(os.path.join("data", "final", "ml_models", "xgboost", f"{disease}.json"))
    ...
    def save_stats(self):
        self.df_stats.to_csv(os.path.join("data", "final", "ml_stats", "xgboost.csv"), index=False)
