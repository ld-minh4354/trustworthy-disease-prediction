...
class SVMModel:
    ...
    def train_disease(self, disease):
        ...
        joblib.dump(model, os.path.join("data", "final", "ml_models", "svm", f"{disease}.pkl"))
    ...
    def save_stats(self):
        self.df_stats.to_csv(os.path.join("data", "final", "ml_stats", "svm.csv"), index=False)
